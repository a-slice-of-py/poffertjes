...
class TestDistributionResult:
    ...
    def test_given_with_variable_skipped(self):
        """Test conditioning with variable - skipped due to calculator dependency."""
        # This test is skipped because it requires ProbabilityCalculator
        # which handles Variable conditioning differently than Expression conditioning
        pytest.skip("Test requires ProbabilityCalculator implementation")
