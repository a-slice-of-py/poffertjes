...
class QueryBuilder:
    ...
    def __init__(self, args: Tuple[Union["Variable", "Expression", "CompositeExpression"], ...]) -> None:
    ...
    def _add_variable_if_not_present(self, variable: "Variable") -> None:
        ...
        for existing_var in self.variables:
            if (existing_var.name == variable.name and 
                existing_var.dataframe_id == variable.dataframe_id):
                return  # Variable already present
        
        # Variable not found, add it
        self.variables.append(variable)

    def _extract_variables_from_composite(self, composite_expr: "CompositeExpression") -> None:
